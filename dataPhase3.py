...
DATASETS = [
    # ── Gros datasets math/code (~2B) ───────────────────────
    {
        ...
        'text_key': 'text',
        'streaming': True,
        'description': 'FineMath-4+ dominant 30%',
        'tokens_per_chunk': 630_000_000,   # 30%
        'int_score_min': 0,
    ...
    },
    {
        ...
        'text_key': 'content',
        'streaming': True,
        'description': 'The Stack Python 15%',
        'tokens_per_chunk': 315_000_000,   # 15%  ─┐ code 25%
        'int_score_min': 0,
        'lang_filter_mode': 'none',
        'skip_general_filter': True,
    },
    {
        'name': 'the_stack_jupyter',
        'source': 'bigcode/the-stack-dedup',
        'config': 'jupyter-scripts-dedup-filtered',
        'split': 'train',
        'text_key': 'content',
        'streaming': True,
        'description': 'The Stack Jupyter notebooks 10%',
        'tokens_per_chunk': 210_000_000,   # 10%  ─┘ (CoT implicite)
        'int_score_min': 0,
        'lang_filter_mode': 'none',
        'skip_general_filter': True,
    },
    {
        ...
        'text_key': 'text',
        'streaming': True,
        'description': 'Cosmopedia v2 textbooks 18%',
    ...
    },
    {
        ...
        'text_key': 'text',
        'streaming': True,
        'description': 'peS2o sciences proofs 10%',
        'tokens_per_chunk': 210_000_000,   # 10%
        'int_score_min': 0,
        'lang_filter_mode': 'none',
        'skip_general_filter': True,
    },
    {
        ...
        'text_key': 'text',
        'streaming': True,
        'description': 'DCLM anti-forgetting 7%',
        'tokens_per_chunk': 147_000_000,   # 7%  ─┐ anti-forgetting
        'int_score_min': 0,
    ...
    },
    {
        ...
        'text_key': 'text',
        'streaming': True,
        'description': 'FineWeb-Edu anti-forgetting 5%',
